...
export const Orders = () => {
 ...
 const [user, setUser] = useState();
  ...
  const handleCreateOrder = async () => {
    ...
    try {
      await axios.post('https://de-uopl.vercel.app/api/orders/create', {
        ...newOrder,
        hotelId,
  ...
  const handleDeleteOrder = async (orderId) => {
    ...
    try {
     ...
     const res =  await axios.delete(`https://de-uopl.vercel.app/api/orders/delete/${orderId}`);
  ...
  const handleFulfill = async (orderId) => {
    ...
    try {
      const response = await axios.post(`https://de-uopl.vercel.app/api/orders/${orderId}/fulfill`,{hotelId});
